...
const QuestionAnalytics = ({analyticsData}) => {
  ...
  const getDifficultyText = (difficulty) => {
    switch (difficulty) {
      case 'easy':
        return t('questionAnalytics.difficulty.easy');
      case 'medium':
        return t('questionAnalytics.difficulty.medium');
      case 'hard':
        return t('questionAnalytics.difficulty.hard');
      default:
        return t('questionAnalytics.difficulty.unknown');
    }
  };
            ...
            <div className="question-header">
              <div className="question-title">
                ...
                <span className="question-number">
                  {t("questionAnalytics.questionNumber", { n: index + 1 })}
                </span>
      ...
      {needsReview.length > 0 && (
        <div className="review-section">
          <h3>
            ...
            {t("questionAnalytics.hardQuestionsTitle", { count: needsReview.length })}
          </h3>
            ...
            {needsReview.map((question) => (
              <div key={question.questionIndex} className="review-item">
                <span className="question-info">
                  {t("questionAnalytics.reviewItem", {
                    n: question.questionIndex + 1,
